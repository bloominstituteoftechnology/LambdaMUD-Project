https://trello.com/b/yDWNY6Q2/lambdamud-charles-cortinas
...
- Response:
  - `{"key":"6b7b9d0f33bd76e75b0a52433f268d3037e42e66"}`
    {"key": "af4acab43238923c3f2d1ab49cd0d56c2cec37cb"}
...
- Response:
  - `{"uuid": "c3ee7f04-5137-427e-8591-7fcf0557dd7b", "name": "testuser", "title": "Outside Cave Entrance", "description": "North of you, the cave mount beckons", "players": []}`
    "uuid": "c695194d-aa76-4bb9-98f2-877d945fa173"

### Move

- Request: (Replace token string with logged in user's auth token)
  - `curl -X POST -H 'Authorization: Token af4acab43238923c3f2d1ab49cd0d56c2cec37cb' -H "Content-Type: application/json" -d '{"direction":"n"}' localhost:8000/api/adv/move/`
- Response:
