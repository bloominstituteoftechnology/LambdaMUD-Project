...
# instantiate pusher
pusher = Pusher(app_id='607082', key='10e2e15a32a50a232621', secret='a3742c0261143170ecca', cluster='us2')
...
def say(request):
    ...
    if message:
        ...
        return JsonResponse({'name': player.user.username, 'message':message, 'error_msg':""}, safe=True, status=200)
    else:
