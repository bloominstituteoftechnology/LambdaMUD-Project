...
def initialize(request):
    """returns player's uuid, username, room, room desc, other players in the room"""
    user = request.user
    player = user.player
    player_id = player.id
    uuid = player.uuid
...
def move(request):
    """
    moves n,e,w,s if possible
    shows users in the room
    shows users entering the room
    shows users exiting the room
    """
