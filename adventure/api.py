...
def initialize(request):
    ''' initializing player info, and room, returns the info json format '''
    user = request.user
    player = user.player
    player_id = player.id
    uuid = player.uuid
...
@api_view(["POST"])
def move(request):
    ''' player (request.player) navigation, and trigger realtime appropirate info to all players in the room'''
